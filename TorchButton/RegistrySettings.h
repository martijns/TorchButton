...
const wchar_t* REGVALUE_VALUE_BRIGHT_MODE_TIMEOUT = L"BrightModeTimeout";
const wchar_t* REGVALUE_VALUE_BLINK_USES_BRIGHT_MODE = L"BlinkUsesBrightMode";
...
const DWORD REGVALUE_DEFAULT_BRIGHT_MODE_TIMEOUT = 10; // Seconds
const DWORD REGVALUE_DEFAULT_BLINK_USES_BRIGHT_MODE = 0; // off
